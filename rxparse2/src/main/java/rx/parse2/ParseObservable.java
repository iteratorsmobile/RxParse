...
public class ParseObservable {
    ...
    public static <R extends ParseObject> Observable<R> all(ParseQuery<R> query, int count) {
        ...
        return find.distinct(ParseObject::getObjectId);
    }
    ...
    public static <R extends ParseObject> Observable<R> fetch(List<R> objects) {
        return TaskObservable.defer(() -> ParseObject.fetchAllInBackground(objects))
                .flatMap(Observable::fromIterable); // v -> Observable.fromIterable(objects)
    }
    ...
    public static Observable<ParseUser> logInWith(String authType, Map<String, String> authData) {
        return TaskObservable.defer(() -> ParseUser.logInWithInBackground(authType, authData));
    }
